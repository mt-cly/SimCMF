...
def build_sam_vit_h(args = None, checkpoint=None, **kwargs):
    return _build_sam(
        args,
...
def build_sam_vit_l(args, checkpoint=None, **kwargs):
    return _build_sam(
        args,
...
def build_sam_vit_b(args, checkpoint=None, **kwargs):
    return _build_sam(
        args,
...
def _build_sam(
    ...
    **kwargs,
    ...
    if checkpoint is not None:
        ...
        print('begin loading pretrained checkpoints')
        with open(checkpoint, "rb") as f:
            state_dict = torch.load(f)
            # if the params name match but size  mismatch, discard the state_dict
