...
class ImageEncoderViT(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.projector = Pre_Callback_Post_Projector(modal_chans=in_chans,
                                                    ...
                                                    **kwargs)
        self.args.medical_adapter_depth=in_chans
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        # med adapter pre-process
        bs = x.shape[0]
        x, _ = self.projector(input=x, func=self.patch_embed)
...
class Block(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        if True:
            ...
            depth = self.args.medical_adapter_depth
